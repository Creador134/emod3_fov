...
def main():
    ...
    print("""
  ######################################
  # EMod Development Environment Setup #
  ######################################

  This script will create your EMod dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your EMod project folder:
    [Arma 3 installation directory]\\{} => EMod project folder
    P:\\{}                              => EMod project folder
